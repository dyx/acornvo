...
export function StatusBar({
  ...
  return (
    <div className="flex h-7 shrink-0 items-center gap-4 border-t border-[color:var(--color-line)] bg-[color:var(--color-paper-3)] px-4 font-mono text-xs text-[color:var(--color-ink-3)]">
      {indexing ? (
