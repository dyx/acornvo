...
| `shared/frontmatter-schema.ts` | Modify (add ai_* fields) | 4.5 |
...
export async function reviewClip(_clipId: number, _opts: ReviewClipOpts = {}): Promise<ReviewClipOutput> {
...
export async function reviewClip(clipId: number, _opts: ReviewClipOpts = {}): Promise<ReviewClipOutput> {
