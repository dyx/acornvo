  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <path
          d="M3 18 Q0.5 14 2 10 Q3.5 6.5 6 6 Q5 9 5.5 12 Q6 14.5 7 16 Z"
          fill={fill}
          stroke={ink}
          strokeWidth="0.9"
          strokeLinejoin="round"
        ...
        {/* body */}
        <path
          d="M6 18 Q5 14 7 11.5 Q9 9.5 11.5 10 Q13 10.5 13 13 L13 18 Z"
          fill={fill}
          stroke={ink}
          strokeWidth="0.9"
          strokeLinejoin="round"
        ...
        {/* head */}
        <path
          d="M10 11 Q9.5 8 11.5 7 Q13.5 6.3 14.8 7.5 Q15.5 8.3 15.3 9.5 Q15 10.8 13.8 11.2 Q12.5 11.6 11 11.2 Z"
          fill={fill}
          stroke={ink}
          strokeWidth="0.9"
          strokeLinejoin="round"
      ...
      <g>
        {/* cap */}
        <path
          d="M22.5 10 Q22.5 7.5 24.5 6.8 Q27 6 29.5 6.8 Q31 7.3 31 10 Z"
          fill={ink}
          stroke={ink}
          strokeWidth="0.9"
          strokeLinejoin="round"
        ...
        {/* body */}
        <path
          d="M23 10.5 Q23 15.5 25 18 Q27 19.5 29 18 Q31 15.5 31 10.5 Z"
          fill={fill}
          stroke={ink}
          strokeWidth="0.9"
          strokeLinejoin="round"
        ...
        <path
          d="M25.5 15.8 Q26.5 16.4 27.5 15.8"
          stroke="var(--ink)"
          strokeWidth="0.6"
          strokeLinecap="round"
          fill="none"
...
const I = {
  Clip: (p) => (
    <Icon
      ...
      d={
        <>
          <path d="M7 7v10a4 4 0 0 0 8 0V5.5a2.5 2.5 0 0 0-5 0V16a1 1 0 0 0 2 0V7" />
        </>
      }
    />
  ),
  ...
  Star: (p) => (
    <Icon
      {...p}
      d="M12 2.5l2.9 6.2 6.6.8-4.9 4.5 1.3 6.5L12 17.3 6.1 20.5l1.3-6.5L2.5 9.5l6.6-.8z"
    />
  ),
    ...
    <Icon
      ...
      d={
        <>
          ...
          <path d="M14 7a3 3 0 0 1 3-3h3v16h-3a3 3 0 0 0-3 3" />
        </>
      }
    />
  ),
  ...
  Tag: (p) => (
    <Icon
      ...
      d={
        <>
          <path d="M20 12V5a1 1 0 0 0-1-1h-7l-9 9 8 8z" />
    ...
    <Icon
      ...
      d={
        <>
          ...
          <path d="M5 3v3M19 17v3M4 5h2M18 18h2" />
        </>
      }
    />
  ),
    ...
    <Icon
      ...
      d={
        <>
          ...
          <path d="M6 8v8" />
          <path d="M6 14c0-4 6-2 6-6 0 0 0-.7 0-0" />
        </>
      }
    />
  ),
  Tool: (p) => (
    <Icon
      ...
      d={
        <>
          <path d="M14 6l3-3 5 5-3 3M10 10L3 17v4h4l7-7" />
        </>
      }
    />
  ),
  ...
  Squirrel: ({ size = 20, color }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0 }}>
      <path
        d="M8 20 Q6 18 6 14 Q6 10 9 9 Q7 7 8 5 Q10 4 12 6 Q14 4 16 6 Q17 8 15 10 Q18 10 18 13 Q22 14 21 18 Q19 17 17 18 L17 20 Z"
        fill={color || 'var(--acorn)'}
        stroke={color || 'var(--acorn-2)'}
        strokeWidth="1"
        strokeLinejoin="round"
      />
