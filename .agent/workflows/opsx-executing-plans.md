---
description: Execute Superpowers plans and sync task completion back to OpenSpec tasks.md. Use when the user has a Superpowers plan ready and wants to start or continue implementation.
---
