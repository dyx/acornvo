...
Defines the /browse route layout structure, WebContentsView lifecycle management (create, close, LRU suspend/resume), and AddressBar input handling for the built-in browser.
