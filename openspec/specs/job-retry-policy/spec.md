# job-retry-policy Specification

## Purpose

Defines the exponential backoff strategy for job queue retries. Provides `nextDelay(attempts)` to determine retry intervals, with handler override support and fatal error handling.
