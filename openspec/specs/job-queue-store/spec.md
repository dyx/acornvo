# job-queue-store Specification

## Purpose
Persistent job storage backed by SQLite. Provides enqueue with dedup, state transition APIs (markRunning/Done/Retry/Failed/Canceled), crash recovery, and list queries for the job queue system.
